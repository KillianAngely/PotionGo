    ...
    <div className="space-y-6">
      ...
      <div className="max-w-3xl rounded-2xl border border-border bg-card p-6 shadow-glow">
        ...
        <div className="mt-6 grid gap-4 text-sm text-muted">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted">Humeur</p>
            <span className={getMoodBadgeStyle(product.mood)}>{product.mood}</span>
          </div>

          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted">Prix</p>
